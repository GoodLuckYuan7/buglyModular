...
public class Module1Activity extends AppCompatActivity {
    ...
    private void initView(){
        title = (TextView) findViewById(R.id.moduleA_title_TextView);
        author = (TextView) findViewById(R.id.moduleA_author_TextView);
        massage = (TextView) findViewById(R.id.moduleA_massage_TextView);
