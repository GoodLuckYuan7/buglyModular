...
public class Module2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_module2ctivity);
        initView();
    }

    private void initView(){
        title = (TextView) findViewById(R.id.moduleB_title_TextView);
        author = (TextView) findViewById(R.id.moduleB_author_TextView);
        massage = (TextView) findViewById(R.id.moduleB_massage_TextView);
